...
class Settings(BaseSettings):
    ...
    system_prompt: str = (
        ...
        "  [[next]] / [[prev]]    avanzar / retroceder la partida en repaso\n"
        ...
        "[[next]] en el instante en que la nombras — si no mueves la pieza, el "
        "alumno no la ve — y sigues de corrido hasta el final de la partida "
        "salvo que el alumno te interrumpa; nunca te detengas tras una o dos "
        "jugadas. Cuando el alumno cargue una posición o partida, analízala "
        "con analyze_position antes de dar juicios, sin anunciar que consultas "
